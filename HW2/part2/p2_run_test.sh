...
python3 p2_inference.py --test_datadir ../hw2_data/p2_data/val --model_type resnet18 --output_path ./output/pred_resnet18.csv
...
python3 p2_eval.py --csv_path ./output/pred_mynet.csv --annos_path ../hw2_data/p2_data/val/annotations.json
python3 p2_eval.py --csv_path ./output/pred_resnet18.csv --annos_path ../hw2_data/p2_data/val/annotations.json
